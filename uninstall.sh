#!/usr/bin/env bash
# Remove all four Softwire Omarchy themes in one shot.
set -euo pipefail
...
is_softwire_current() {
  case "${1:-}" in
    "Softwire Black"|"Softwire Blue"|"Softwire Green"|"Softwire Red"|softwire-black|softwire-blue|softwire-green|softwire-red)
      return 0
      ;;
    *)
      return 1
...
echo
echo "Removed Softwire Black, Blue, Green, and Red."
