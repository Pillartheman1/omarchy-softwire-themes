local active_border_color = "#727272"
local inactive_border_color = "rgba(c0c0c0aa)"
...
-- Slightly more opaque than Softwire Black so light glass stays readable.
local opacity_rule = "0.80 override 0.80 override 1.0 override"
